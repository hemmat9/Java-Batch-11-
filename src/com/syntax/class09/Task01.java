...
public class Task01 {
	...
	public static void main(String[] args) {
		// Create an array of char and store grades into it:A,B,C,D,E,F. Then print a grade B.
		...
		// we can not declare an array separately if we want to store values in shorter way, compiler will complain on the second line.
		//int [] num;
		//num={10,12,13,14,15};
